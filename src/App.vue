    ...
    <header className='navbar'>
      <div className='container'>
        <div className='logo'><router-link style="text-decoration: none; color: inherit; vertical-align: bottom; margin-top: 0.1rem; " :to="{name: 'Home'}"><mark class="purple"> ⫓ </mark>Swap.Dance</router-link></div>
          ...
          <a style="text-decoration: none; color: inherit;" href="https://docs.swap.dance/how-does-it-work/proof-of-trade" target="_blank"><p style="margin-top: 0.1rem; margin-bottom: 0.5rem;">Docs</p></div></a>
