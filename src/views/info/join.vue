...
export default {
  ...
  setup() {
    ...
    useMeta({
      title: 'Join to Community : Swap.Dance', 
      htmlAttrs: { lang: 'en', amp: true },
      keywords: 'Swap.Dance, DANCE token, Trading Community, Trader Chat, Crypto Trading Community, Swap tokens, Exchange tokens, DEX, AMM',
    })
