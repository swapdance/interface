        ...
        <div className='card'>
          ...
          <div className='simple-card' style="background: white">
            <div className='wrapper2a' style="margin-bottom: 1rem; grid-template-columns: 2.9fr 0.2fr;">
              ...
              <a style="text-decoration: none; color: inherit;" href="https://docs.swap.dance/how-does-it-work/super-pool/unlock-dance" target="_blank"><div class="help-tip"></div></a>
            </div>
...
export default {
  ...
  setup() {
    ...
    useMeta({
      ...
      description: 'Unlock your DANCE token to claim the reward. Super pool has two phases: LP-Forming and LP-Distribution. During the first stage you can lock your DANCE token reward to receive a set of 10 LP of your choice when the super pool will change status to LP-Distribution.',
