        ...
        <div className='card'>
          ...
          <div className='simple-card' style="background: white">
            <div className='wrapper2a' style="margin-bottom: 1rem; grid-template-columns: 2.9fr 0.2fr;">
              ...
              <a style="text-decoration: none; color: inherit;" href="https://docs.swap.dance/how-does-it-work/super-pool" target="_blank"><div class="help-tip"></div></a>
            </div>
            ...
            <div className='wrapper2inline' style="margin-bottom: 1rem;">
              <p style="text-align: left;">Collected</p>
