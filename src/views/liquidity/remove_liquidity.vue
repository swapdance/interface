        ...
        <div className='card'>
          ...
          <div className='simple-card'>
            ...
            <div className='wrapper3'>
              ...
              <input 
                ...
                id="lp_input_amount" 
                :value="LP_amount" 
                @input="LP_amount = $event.target.value" 
                :oninput="handleInput" 
                inputmode="numeric" 
                placeholder="1.0"
              >
          ...
          <div className='simple-card' style="background: white">
            <div className='wrapper2a' style="margin-bottom: 1rem; grid-template-columns: 2.9fr 0.2fr;">
              ...
              <a style="text-decoration: none; color: inherit;" href="https://docs.swap.dance/how-does-it-work/remove-liquidity" target="_blank"><div class="help-tip"></div></a>
            </div>
