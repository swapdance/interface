        ...
        <div className='card'>
          ...
          <div className='simple-card' style="background: white">
            <div className='wrapper2a' style="margin-bottom: 1rem; grid-template-columns: 2.9fr 0.2fr;">
              ...
              <a style="text-decoration: none; color: inherit;" href="https://docs.swap.dance/how-does-it-work/proof-of-trade/unstake-lp-tokens" target="_blank"><div class="help-tip"></div></a>
            </div>
