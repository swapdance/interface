...
export default {
  ...
  setup() {
    ...
    useMeta({
      ...
      description: 'Type an amount of DANCE tokens you want to lock, then select a set of 10 LP tokens on your choice to receive estimate reward to withdraw at LP-Distribution cycle.',
